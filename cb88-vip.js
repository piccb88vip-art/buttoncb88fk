  ...
  document.body.insertAdjacentHTML('beforeend', `
    <div id="cb88-vip-widget">
      ...
      <div class="cb88-vip-popup">
        ...
        <div class="cb88-vip-medal">
          <img src="${logoVipUrl}" alt="CLICKBET88 VIP">
        </div>
      </div>
    </div>
    ...
    <style>
      ...
      .cb88-vip-tab{
        ...
        gap:1px;
        color:#ffe793;
        background:linear-gradient(180deg,#173b8c,#060d35 55%,#102965);
      ...
      .cb88-vip-popup{
        ...
        border:1px solid #d6ac3c;
        border-left:3px solid #e7c45d;
      ...
      .cb88-vip-content a{
        ...
        padding:6px 8px;
        color:#211400;
        background:linear-gradient(135deg,#fff0a3,#d19a25 58%,#ffe27b);
      ...
      .cb88-vip-content a:hover{
        filter:brightness(1.1);
      }

      .cb88-vip-content a b{
        font-size:16px;
        line-height:8px;
      }
      ...
      .cb88-vip-medal{
        ...
        overflow:hidden;
        border-radius:50%;
        border:2px solid #f3d064;
        background:#090909;
        box-shadow:0 0 0 2px #70480b,0 0 10px #ffda5d,0 4px 8px #000b;
      }
      ...
      @media(max-width:600px){
        ...
        .cb88-vip-popup{
          left:42px;
          width:min(270px,calc(100vw - 49px));
        }
      }
    </style>
  `);
